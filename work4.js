...
bot.on('message', async (msg) => {
    ...
    if (msg.text==='/start') {
      ...
      await bot.sendPhoto(chatId, 'b.png', {
        caption: 'Welcome to ASTU IF Telegram bot.',
        parse_mode: 'HTML',
        ...
        if (love === '/web_link') {
            const link = 'https://astuif.com'; // Replace with your desired link
            const message = `Click the link below to go to the main website:\n${link}`;
          ...
          if (command.startsWith('//')) {
            ...
            await bot.sendMessage(chatId, `Welcome Back`, options);
            await bot.sendPhoto(chatId, 'b.png');
